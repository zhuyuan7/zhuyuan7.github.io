...
![명사](https://zhuyuan7.github.io/assets/images/명사.jpg "명사"){: .align-center}<center> <그림 6> 명사형 전성 어미 '-(으)ㅁ' </center> 
<br>
...
한국어 자연어 처리를 탑제한 말하는 로봇을 상용화시키려면 평생을 바쳐 연구해야 
그나마 좀 인간답게 말할 수 있는 로봇을 개발 할 수 있지 않을까.

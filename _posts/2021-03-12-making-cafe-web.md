...
자연어 처리를 처음 접했을 누군가들은 분명 [네이버 영화후기 분석](https://wikidocs.net/44249)을 
해봤을 것이다. 나 또한 그 작업을 수행하면서 언제부터 컴퓨터가 한국어텍스트를 이해하고 
이게 명사인지 동사인지 형용사인지를 분석할 수 있는 경지에 올랐는 지!
그 떄 느꼈던 그 감정은 개인적으로 굉장히 흥미를 느낀 것 이상으로
말로는 형용할 수 없을 정도였다.

이정도의 한국어 자연어 처리 성능을 갖기까지 엄청난 훈련을 했다는 말인데,
마치 어학당에서 영어가 모국어인 외국인 유학생에게 한국말을 가르치듯이 
기본 언어가 영어로 구성된 컴퓨터에게 한국어를 가르치는 것과 같은 상황!이라고
하면 쉽게 이해가 간다.

...
한국인이 사용하는 대표적인 포털 사이트는 크게 네이버, 다음, 구글을 꼽을 수 있다.
 ...
 특정 검색어를 검색하여 "정보의 양"을 비교해보기로 했다.
 대표적으로 유동인구가 많은 강남구의 카페를 예시로 검색어를 설정(검색어: **강남구 카페**)하여 다음과 같은 결과를 도출했다.
...
|:----------------------:	|:---------:	|:-------------:	|:---------:	|
|       포털 사이트      	|   네이버  	|  **카카오맵** 	|    구글   	|
|      총 페이지 수 (page)      	|  6 페이지 	|   34 페이지   	| 15 페이지 	|
| 한 페이지 당 결과물 수(size) 	|   50 개   	|     15 개     	|   20 개   	|
|     총 정보 제공 수 (total count)   	| 총 300 개 	| 총 **510** 개 	| 총 300 개 	|
</center>
<br> 네이버, 카카오맵, 구글 중 카카오맵의 정보제공 양이 압도적으로 많은 것으로 나타났기 때문에
카카오맵 상에서 카페정보를 수집하기로 최종결정하였다.

<br>본래 계획은 카카오 REST API를 이용해 카페의 정보를 수집하기로 하였으나, 카카오 REST API를 사용하여
정보수집을 시도해 보았지만, 최대 45 page x 15 size의 정보만을 제공하므로 정보제공 개수의 제한이 있어 방대한 양의 정보를 수집하기엔 적합하지 않다고
판단하였다. 
<br>

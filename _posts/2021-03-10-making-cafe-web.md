...
이 글에서는 카카오맵 상의 카페정보 데이터 크롤링 과정을 소개한다.
<br>
...
코드를 작성해 서울시 25개 구 카페의 **"카페명"+"주소"+"영업시간"+"전화번호"+"대표사진주소"** 에 대한
...
이 댓글이 어느 카페의 댓글인지 구별할 수 있도록 미리 각 카페에 대해 "구(이니셜)"와 "ID(수집된 순서 순)"를 부여하여 
고유 식별자를 설정하였다.  
...
<br>
## 3. 카페정보 수집 코드
서울특별시 25개 구의 카페정보 수집 코드는 다음과 같다.

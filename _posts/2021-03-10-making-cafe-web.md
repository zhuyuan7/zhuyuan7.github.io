...
|   |   포털   | 총 페이지 수 | 한 페이지 당 결과물 수 | 총 정보 제공 수 |
|---|:--------:|:------------:|:----------------------:|:---------------:|
| 1 |  네이버  |   6 페이지   |          50 개         |    총 300 개    |
| 2 | 카카오맵 |   34 페이지  |          15 개         |  총 **510** 개  |
| 3 |   구글   |   15 페이지  |          20 개         |    총 300 개    |

<br> 네이버, 카카오맵, 구글 중 카카오맵의 정보제공 양이 압도적으로 많은 것으로 나타났기 때문에
카카맵 상에서 카페정보를 수집하기로 최종결정하였다.

<br>정보를 수집하기 위해 카카오맵 API를 사용 시도를 해보았다. 하지만
